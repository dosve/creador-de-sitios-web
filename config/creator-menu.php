...
return [
    ...
    'items' => [
        ...
        [
            ...
            'active_routes' => ['creator.config.*', 'creator.websites.duplicate'],
            'requires_website' => true,
            'items' => [  // DROPDOWN
                [
                ...
                [
                    ...
                    'route' => 'creator.websites.duplicate',
                    ...
                    'active_routes' => ['creator.websites.duplicate'],
                    'params_website' => true, // Necesita parámetro website
                ],
                [
