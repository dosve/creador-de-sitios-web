    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Únete y comienza a crear sitios web profesionales
            </p>
        </div>
        ...
        <div class="mt-8 p-4 bg-green-50 rounded-md">
            <h3 class="text-sm font-medium text-green-800 mb-2">¡Plan Gratuito incluido!</h3>
            <div class="text-xs text-green-700 space-y-1">
                <p>• 1 sitio web</p>
                <p>• 5 páginas</p>
                <p>• Editor visual drag & drop</p>
                <p>• Plantillas básicas</p>
            </div>
        </div>
    </div>
</body>
