  ...
  <div class="flex flex-col min-h-screen">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        , blockManager: {
          ...
          , blocks: [
            ...
            , {
              id: 'hero'
              , label: 'Hero'
              , content: `<section class="py-20 text-white bg-gradient-to-r from-blue-600 to-purple-600">
                            <div class="container mx-auto text-center">
                                <h1 class="mb-4 text-5xl font-bold">Tu Título Aquí</h1>
                                <p class="mb-8 text-xl">Descripción de tu producto o servicio</p>
                                <button class="px-8 py-3 font-semibold text-blue-600 bg-white rounded-lg hover:bg-gray-100">Call to Action</button>
                            </div>
                        </section>`
            , }
            , {
              ...
              , content: `<section class="py-16 bg-white">
                            <div class="container px-4 mx-auto">
                                <h2 class="mb-12 text-3xl font-bold text-center">Nuestras Características</h2>
                                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                                    <div class="text-center">
                                        ...
                                        <h3 class="mb-2 text-xl font-semibold">Rápido</h3>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h3 class="mb-2 text-xl font-semibold">Confiable</h3>
                                        <p class="text-gray-600">Descripción de la característica</p>
                                    </div>
                                    <div class="text-center">
                                        ...
                                        <h3 class="mb-2 text-xl font-semibold">Fácil</h3>
                                        <p class="text-gray-600">Descripción de la característica</p>
                                    </div>
                                </div>
                            </div>
      ...
      if (!container) {
        ...
        alert('Error: Contenedor del editor no encontrado');
        return;
      }
      console.log('Contenedor encontrado:', container);

      // Cargar contenido existente
      const existingHtmlContent = @json($page->html_content);
      const existingCssContent = @json($page->css_content);

      if (existingHtmlContent) {
        editor.setComponents(existingHtmlContent);
      }

      if (existingCssContent) {
        editor.setStyle(existingCssContent);
      }
      ...
      document.getElementById('save-btn').addEventListener('click', function() {
        ...
        .then(data => {
          hideSaveLoading();
          if (data.success) {
            showNotification('Página guardada exitosamente', 'success');
          } else {
