...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Form -->
        <div class="mt-8">
            <form action="{{ route('creator.forms.update', [$website, $form]) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select name="type" id="type" 
                                            ...
                                            <option value="contact" {{ old('type', $form->type) == 'contact' ? 'selected' : '' }}>Formulario de Contacto</option>
                                            <option value="custom" {{ old('type', $form->type) == 'custom' ? 'selected' : '' }}>Formulario Personalizado</option>
                                        </select>
                                    </div>
                                    @error('type')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea name="description" id="description" rows="3"
                                                  ...
                                                  placeholder="Describe el propósito de este formulario...">{{ old('description', $form->description) }}</textarea>
                                    </div>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="email" name="email_to" id="email_to" 
                                               value="{{ old('email_to', $form->email_settings['to'] ?? '') }}"
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="email_subject" id="email_subject" 
                                               value="{{ old('email_subject', $form->email_settings['subject'] ?? 'Nuevo mensaje desde el formulario') }}"
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea name="success_message" id="success_message" rows="2"
                                                  ...
                                                  placeholder="¡Gracias! Tu mensaje ha sido enviado correctamente.">{{ old('success_message', $form->success_message) }}</textarea>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea name="error_message" id="error_message" rows="2"
                                                  class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md @error('error_message') border-red-300 @enderror"
                                                  placeholder="Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo.">{{ old('error_message', $form->error_message) }}</textarea>
                                    </div>
                                    @error('error_message')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
