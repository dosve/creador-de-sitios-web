                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-lg font-medium text-gray-900">Crear Nuevo Artículo</h3>
                                <p class="mt-1 text-sm text-gray-600">Agrega un nuevo artículo al blog.</p>
                            </div>
                            <a href="{{ route('creator.blog.index') }}" class="text-gray-600 hover:text-gray-900">
                    ...
                    <form method="POST" action="{{ route('creator.blog.store') }}" class="px-6 py-4">
                        @csrf
                                ...
                                <div>
                                    ...
                                    <div id="editor-container" style="min-height: 400px;">
                                        <textarea id="content"
                                            ...
                                            autocomplete="off"
                                            data-form-type="other">{{ old('content') }}</textarea>
                                    </div>
                                    @error('content')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mt-6 flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                            <a href="{{ route('creator.blog.index') }}" 
