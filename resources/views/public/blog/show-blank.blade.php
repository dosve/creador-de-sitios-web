...
<head>
    ...
    <style>
        ...
        .prose blockquote { border-left: 4px solid #3B82F6; padding-left: 1rem; margin: 1.5rem 0; font-style: italic; color: #6B7280; }
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
                            ...
                            <article class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                                ...
                                <div class="p-4">
                                    ...
                                    <h4 class="text-lg font-bold text-gray-900 mb-2 hover:text-blue-600">
                                        <a href="{{ url($website->slug . '/blog/' . $relatedPost->slug) }}">{{ $relatedPost->title }}</a>
                                    </h4>
            ...
            <div class="mt-12 flex flex-wrap gap-4 justify-between">
                <a href="{{ url($website->slug . '/blog') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">← Volver al blog</a>
                <a href="{{ url($website->slug) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">Ir al inicio</a>
            </div>
        </div>
    </div>
