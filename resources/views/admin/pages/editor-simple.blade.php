...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
      // Configuración básica de GrapesJS
      ...
      const existingContent = {
        !!json_encode($page - > html_content) !!
      };
      const existingCSS = {
        !!json_encode($page - > css_content ?? '') !!
      };
      const existingData = {
        !!json_encode($page - > grapesjs_data) !!
      };
      ...
      document.getElementById('gjs').innerHTML = '<div style="padding: 20px; text-align: center; color: red;">Error al cargar el editor: ' + error.message + '</div>';
    }
  });
</script>
@endsection