...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500">Configura una nueva categoría para organizar artículos de blog</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" class="p-6 space-y-6">
            ...
            <div>
                <label for="color" class="block text-sm font-medium text-gray-700">Color de la Categoría</label>
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t">
                <a href="{{ route('admin.categories.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancelar
                </a>
