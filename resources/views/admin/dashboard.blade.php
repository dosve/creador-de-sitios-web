                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Planes Disponibles</dt>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Usuarios Recientes</h3>
                        <div class="flow-root">
                            <ul class="-my-5 divide-y divide-gray-200">
                                ...
                                @empty
                                <li class="py-4 text-center text-gray-500">No hay usuarios registrados</li>
                                @endforelse
                            </ul>
                        </div>
                    </div>
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Sitios Web Recientes</h3>
                        <div class="flow-root">
                            <ul class="-my-5 divide-y divide-gray-200">
                                @forelse($recent_websites as $website)
                                <li class="py-4">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-sm text-gray-500 truncate">Por: {{ $website->user->name }}</p>
                                        </div>
                                        <div>
                                ...
                                @empty
                                <li class="py-4 text-center text-gray-500">No hay sitios web creados</li>
                                @endforelse
                            </ul>
                        </div>
                    </div>
