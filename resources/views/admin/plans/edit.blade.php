...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500">Modifica la información del plan de suscripción</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.plans.update', $plan) }}" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $plan->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="max_websites" id="max_websites" value="{{ old('max_websites', $plan->max_websites) }}" min="1" required
                    ...
                    <div>
                        ...
                        <input type="number" name="max_pages" id="max_pages" value="{{ old('max_pages', $plan->max_pages) }}" min="1" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="custom_domain" id="custom_domain" value="1" {{ old('custom_domain', $plan->custom_domain) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="ecommerce" id="ecommerce" value="1" {{ old('ecommerce', $plan->ecommerce) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="seo_tools" id="seo_tools" value="1" {{ old('seo_tools', $plan->seo_tools) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="analytics" id="analytics" value="1" {{ old('analytics', $plan->analytics) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
