...
<head>
    ...
    <title>Blog - Músico Banda</title>
    <meta name="description" content="Noticias de la banda, conciertos, música y más. Mantente al día con nuestras últimas novedades.">
    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl font-heading">Blog de la Banda</h1>
                <p class="mt-5 max-w-xl mx-auto text-xl text-gray-500">Noticias, conciertos y novedades musicales.</p>
            </div>
        </div>
    </div>
    <!-- Blog Posts Grid -->
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-purple-600">
                                <a href="#" class="hover:underline">
                                    Categoría {{ $i % 3 == 0 ? 'Conciertos' : ($i % 3 == 1 ? 'Música' : 'Noticias') }}
                                </a>
                            </p>
