...
<head>
    ...
    <title>Blog - Portafolio Fotógrafo</title>
    <meta name="description" content="Consejos de fotografía, técnicas y novedades. Mantente actualizado con las últimas tendencias fotográficas.">
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl font-heading">Blog Fotográfico</h1>
                <p class="mt-5 max-w-xl mx-auto text-xl text-gray-500">Consejos, técnicas y novedades del mundo fotográfico.</p>
            </div>
        </div>
    </div>
    <!-- Blog Posts Grid -->
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-cyan-600">
                                <a href="#" class="hover:underline">
                                    Categoría {{ $i % 3 == 0 ? 'Técnica' : ($i % 3 == 1 ? 'Equipo' : 'Inspiración') }}
                                </a>
                            </p>
                            <a href="#" class="block mt-2">
                                <p class="text-xl font-semibold text-gray-900">
                                    Artículo Fotográfico {{ $i + 1 }}
                                </p>
        ...
        <div class="text-center mt-12">
            <button class="bg-cyan-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-cyan-700 transition-colors">
