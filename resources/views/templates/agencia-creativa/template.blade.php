...
<head>
  ...
  @endphp
  @if($templateCssHelper::hasCss('agencia-creativa'))
    {!! $templateCssHelper::renderCss('agencia-creativa', $customization ?? []) !!}
  @endif
...
<body class="bg-gray-50 agencia-template" data-page-id="{{ $page ? $page->id : '' }}">
