...
<head>
    ...
    <title>Blog - Agencia Creativa</title>
    <meta name="description" content="Ideas, inspiración y tendencias del mundo creativo. Mantente actualizado con nuestros últimos artículos.">
    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                ...
                <p class="mt-5 max-w-xl mx-auto text-xl text-gray-500">Ideas, inspiración y tendencias del mundo creativo.</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-indigo-600">
                                <a href="#" class="hover:underline">
                                    {{ $i % 3 == 0 ? 'Diseño' : ($i % 3 == 1 ? 'Marketing' : 'Branding') }}
                                </a>
                            </p>
