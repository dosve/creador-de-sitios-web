...
<head>
    ...
    <title>Blog - Inmobiliaria</title>
    <meta name="description" content="Consejos inmobiliarios, tendencias del mercado y tips para comprar o vender propiedades.">
    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl font-heading">Blog Inmobiliario</h1>
                <p class="mt-5 max-w-xl mx-auto text-xl text-gray-500">Consejos y tendencias del mercado inmobiliario.</p>
            </div>
        </div>
    </div>
    <!-- Blog Posts Grid -->
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-indigo-600">
                                <a href="#" class="hover:underline">
                                    Categoría {{ $i % 3 == 0 ? 'Venta' : ($i % 3 == 1 ? 'Alquiler' : 'Inversión') }}
                                </a>
                            </p>
                            <a href="#" class="block mt-2">
                                <p class="text-xl font-semibold text-gray-900">
                                    Artículo Inmobiliario {{ $i + 1 }}
                                </p>
