...
<head>
  ...
  @endphp
  @if($templateCssHelper::hasCss('tienda-minimalista'))
    {!! $templateCssHelper::renderCss('tienda-minimalista', $customization ?? []) !!}
  @endif
...
<body class="bg-white tienda-minimalista-template" data-page-id="{{ $page ? $page->id : '' }}">
